...
_fetch_qt = repository_rule(
    ...
    attrs = {
        "_build_script_windows": attr.label(default = "@bazel_qt//:build_windows.bat"),
        "_build_script_linux": attr.label(default = "@bazel_qt//:build_linux.sh"),
        "_build_template": attr.label(default = "@bazel_qt//:qt.BUILD"),
